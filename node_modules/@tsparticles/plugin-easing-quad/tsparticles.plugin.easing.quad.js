...
(function (global, factory) {
    ...
    easingsFunctions.set(engine.EasingType.easeInQuad, value => value ** 2);
    easingsFunctions.set(engine.EasingType.easeOutQuad, value => 1 - (1 - value) ** 2);
    easingsFunctions.set(engine.EasingType.easeInOutQuad, value => (value < 0.5 ? 2 * value ** 2 : 1 - (-2 * value + 2) ** 2 / 2));
