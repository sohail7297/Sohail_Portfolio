...
(function (global, factory) {
    ...
    const generatedAttribute = "generated", defaultCompositeValue = "source-over", resizeEvent = "resize", visibilityChangeEvent = "visibilitychange", percentDenominator = 100, half$1 = 0.5, millisecondsToSeconds = 1000, originPoint = {
        ...
        c: 0,
        d: 1,
    }, randomColorValue = "random", midColorValue = "mid", double = 2, doublePI = Math.PI * double, defaultFps = 60, defaultAlpha$1 = 1, generatedTrue = "true", generatedFalse = "false", canvasTag = "canvas", defaultRetryCount = 0, squareExp$1 = 2, spatialHashGridCellSize = 100, defaultRemoveQuantity = 1, defaultRatio$1 = 1, defaultReduceFactor = 1, inverseFactorNumerator = 1, rgbMax = 255, hMax = 360, sMax = 100, lMax = 100, hMin = 0, sMin = 0, hPhase = 60, empty = 0, quarter = 0.25, threeQuarter = half$1 + quarter, minVelocity$6 = 0, defaultTransformValue = 1, minimumSize = 0, zIndexFactorOffset = 1, defaultOpacity$3 = 1, removeDeleteCount = 1, removeMinIndex = 0, defaultFpsLimit = 120, minFpsLimit = 0, canvasFirstIndex = 0, loadRandomFactor = 10000, loadMinIndex = 0, one = 1, none = 0, decayOffset = 1, tryCountIncrement = 1, minZ = 0, minLimit = 0, countOffset = 1, minCount = 0, minIndex = 0, lengthOffset = 1, defaultDensityFactor = 1, deleteCount = 1, defaultAngle = 0, identity$3 = 1, minStrokeWidth = 0, lFactor = 1, lMin = 0, triple = 3, sextuple = 6, sNormalizedOffset = 1, phaseNumerator = 1, defaultRgbMin = 0, defaultVelocity = 0, defaultLoops = 0, defaultTime = 0, defaultZoom = 1;
    ...
    class Circle extends BaseRange {
        ...
        intersects(range) {
            ...
            if (range instanceof Circle || range.type === RangeType.circle) {
                ...
                const rectRange = range, { width, height } = rectRange.size, edges = Math.pow(dx - width, squareExp$1) + Math.pow(dy - height, squareExp$1);
    ...
    function bounceHorizontal(data) {
        ...
        let bounced = false;
        if (data.outOfCanvas &&
            ((data.direction === exports.OutModeDirection.right && velocity > minVelocity$5) ||
                (data.direction === exports.OutModeDirection.left && velocity < minVelocity$5))) {
    ...
    function bounceVertical(data) {
        ...
        let bounced = false;
        if (data.outOfCanvas &&
            ((data.direction === exports.OutModeDirection.bottom && velocity > minVelocity$5) ||
                (data.direction === exports.OutModeDirection.top && velocity < minVelocity$5))) {
...
Object.assign(globalThis.window || globalThis, { loadMinIndex: (globalThis.__tsParticlesInternals.bundles.slim || {}).loadMinIndex, loadOptions: (globalThis.__tsParticlesInternals.bundles.slim || {}).loadOptions, loadParticlesOptions: (globalThis.__tsParticlesInternals.bundles.slim || {}).loadParticlesOptions, loadRandomFactor: (globalThis.__tsParticlesInternals.bundles.slim || {}).loadRandomFactor, loadSlim: (globalThis.__tsParticlesInternals.bundles.slim || {}).loadSlim, tsParticles: (globalThis.__tsParticlesInternals.bundles.slim || {}).tsParticles });
