...
(function (global, factory) {
    ...
    function applyPath(particle, delta) {
        ...
        if (pathOptions.clamp) {
            particle.velocity.x = engine.clamp(particle.velocity.x, -identity, identity);
            particle.velocity.y = engine.clamp(particle.velocity.y, -identity, identity);
        }
    ...
    function initSpin(container, particle) {
        ...
        particle.spin = {
            center: spinCenter,
            direction: particle.velocity.x >= minVelocity ? engine.RotateDirection.clockwise : engine.RotateDirection.counterClockwise,
