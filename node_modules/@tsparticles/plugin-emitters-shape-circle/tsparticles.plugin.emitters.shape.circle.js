...
(function (global, factory) {
    ...
    class EmittersCircleShape extends pluginEmitters.EmitterShapeBase {
        ...
        randomPosition() {
            ...
            }, radius = (x, y, theta) => (x * y) / Math.sqrt((y * Math.cos(theta)) ** squareExp + (x * Math.sin(theta)) ** squareExp), [a, b] = [size.width * engine.half, size.height * engine.half], randomTheta = generateTheta(a, b), maxRadius = radius(a, b, randomTheta), randomRadius = fill ? maxRadius * Math.sqrt(engine.getRandom()) : maxRadius;
            return {
                position: {
