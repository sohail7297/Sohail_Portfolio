...
(function (global, factory) {
    ...
    class EmitterRate {
        ...
        load(data) {
            ...
            if (data.quantity !== undefined) {
                this.quantity = engine.setRangeValue(data.quantity);
            }
            if (data.delay !== undefined) {
                this.delay = engine.setRangeValue(data.delay);
            }
    ...
    class EmitterSize {
        ...
        width;
        constructor() {
            this.mode = engine.PixelMode.percent;
            this.height = 0;
            this.width = 0;
        }
        load(data) {
                ...
                if (engine.isArray(modeEmitters.value)) {
                    ...
                    if (modeEmittersCount > minLength && modeEmitters.random.enable) {
                        ...
                        for (let i = 0; i < modeEmitters.random.count; i++) {
                            const idx = engine.arrayRandomIndex(modeEmitters.value);
    ...
    class EmitterInstance {
        ...
        constructor(pluginManager, container, removeCallback, options, position) {
            ...
            this.size = engine.getSize(this.#size, this.#container.canvas.size);
        ...
        resize() {
            ...
            this.position =
                initialPosition && engine.isPointInside(initialPosition, container.canvas.size, engine.Vector.origin)
                    ...
                    : this.#calcPosition();
            this.#size = this.#calcSize();
            this.size = engine.getSize(this.#size, container.canvas.size);
